        ...
        <div id="support2" className="flex flex-col gap-12 bg-white min-h-screen w-screen py-16 px-5 text-[#0B0105] text-center items-center lg:py-28 lg:px-16 lg:gap-20">
            ...
            <div className="flex flex-col lg:grid lg:grid-cols-3 gap-12">
                <div className="flex flex-col items-center gap-4 lg:gap-6">
                    ...
                    <p className="text-2xl font-jost leading-8 lg:text-4xl lg:leading-10">Grupos de Apoio para Conexão e Crescimento</p>
                    <p className="font-ibm text-base leading-6">Participe dos nossos grupos de apoio para encontrar comunidade e compreensão.</p>
                </div>

                <div className="flex flex-col items-center gap-4 lg:gap-6">
                    <img src="/icon.svg" alt="icon" className="size-12" />
                    <p className="text-2xl font-jost leading-8 lg:text-4xl lg:leading-10">Recursos Educacionais para uma Parentalidade Informada</p>
                    <p className="font-ibm text-base leading-6">Acesse recursos valiosos para ajudá-lo em sua jornada.</p>
                </div>

                <div className="flex flex-col items-center gap-4 lg:gap-6">
                    <img src="/icon.svg" alt="icon" className="size-12" />
                    <p className="text-2xl font-jost leading-8 lg:text-4xl lg:leading-10">Defesa dos Direitos e Inclusão</p>
