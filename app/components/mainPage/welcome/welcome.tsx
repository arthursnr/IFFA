export function Welcome() {
    return (
        <div id="welcome" className="flex flex-col  gap-5 text-white bg-[#5E5EDA] min-h-screen min-w-screen py-12 px-5">
            <p className="text-4xl font-jost">Seja bem vindo ao Fórum de Famílias Atípicas</p>
