export function Welcome() {
    return (
        <div id="welcome" className="text-white bg-[#5E5EDA] min-h-screen min-w-screen lg:grid lg:grid-cols-2 lg:items-center lg:px-16">
            <img src="/mainphoto.jpg" alt="Foto da Familia IFFA" className="w-screen lg:w-3xl lg:rounded-lg lg:shadow h-fit" />
            <div className="flex flex-col gap-5 py-12 px-5 lg:grid lg:grid-cols-1 lg:items-center lg:px-16 lg:py-20 lg:gap-20">
